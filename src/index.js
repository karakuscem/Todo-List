...
const startApp = () => {
    if(!todoItems) {
        localStorage.setItem("todoItems", JSON.stringify([{"isCompleted":false,"title":"Do Homework","description":"Do Math book p64-68","date":"2022-08-27"},{"isCompleted":false,"title":"Wash dishes","description":"I better do it before my mom comes","date":"2022-08-27"},{"isCompleted":false,"title":"Go Gym","description":"Lift like animal 💪","date":"2022-08-27"},{"isCompleted":false,"title":"Meeting with friends","description":"8pm at Coffee shop","date":"2022-08-31"},{"isCompleted":false,"title":"Code To-Do App","description":"Check Odin Project","date":"2022-09-03"},{"isCompleted":false,"title":"Apply for University","description":"Last Date 16 September","date":"2022-09-10"}]));
    }
